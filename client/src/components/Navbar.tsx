      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            />
            <span className="text-xl font-bold" style={{ display: "none", color: "#1a3a2a" }}>
              {t("navbar.logo")}<span style={{ color: "#5a9a7d" }}>{t("navbar.logoName")}</span>
            </span>
          </motion.div>
          ...
          <nav className="hidden lg:flex items-center space-x-5">
            {menuItems.map((item, index) => (
              <motion.button
                ...
                style={{
                  color: activeSection === item.id ? "#5a9a7d" : "#494949"
                }}
              >
                {item.label}
            ...
            <div className="flex items-center space-x-4 ml-2">
              <a href="https://wa.me/5511996058392" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-70" aria-label="WhatsApp">
              ...
              <a href="https://www.instagram.com/dra.anacarolina.ped" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-70" aria-label="Instagram">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#494949">
              ...
              <a href="mailto:contato@pediatradranacarolina.com.br" className="transition-opacity hover:opacity-70" aria-label="E-mail">
          ...
          >
            {menuItems.map((item) => (
              <button
                ...
                style={{
                  color: activeSection === item.id ? "#5a9a7d" : "#494949",
                  backgroundColor: activeSection === item.id ? "#EAF4EF" : "transparent"
                }}
              >
                {item.label}
              </button>
